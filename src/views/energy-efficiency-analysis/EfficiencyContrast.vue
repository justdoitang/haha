  ...
  <div class="app-container">
    <el-card v-loading="loading" shadow="never">
      <div class="toolbar-wrapper">
        <div>
          <el-select v-model="searchData.selectObj" placeholder="设备选择" style="width: 120px; margin-right: 10px">
      ...
      <div class="table-wrapper">
        <el-table :data="tableData" border stripe>
          ...
          <el-table-column prop="username" label="整体值" align="center" />
          <el-table-column prop="username" label="平均值" align="center" />
          <el-table-column prop="username" label="10%最优平均值" align="center" />
          <el-table-column prop="username" label="10%最差平均值" align="center" />
        </el-table>
      </div>
    </el-card>
  </div>
