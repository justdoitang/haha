      ...
      <div class="toolbar-wrapper">
        <div>
          ...
          <el-select
            ...
            style="width: 150px; margin-right: 10px"
          >
            <el-option v-for="item in alarmLevel" :key="item.value" :label="item.label" :value="item.value" />
          </el-select>
          <el-date-picker
            type="month"
        ...
        <div>
          <el-button type="primary">保存csv格式</el-button>
          <el-button type="primary">保存为excel格式</el-button>
          <el-button type="primary">保存为pdf格式</el-button>
          <el-button type="primary">标识阅读</el-button>
        </div>
      </div>
