  ...
  <div class="app-container">
    <el-card v-loading="loading" shadow="never">
      <div class="toolbar-wrapper">
        <div>
          <el-select v-model="searchData.selectObj" placeholder="位置区域" style="width: 120px; margin-right: 10px">
          ...
          <el-date-picker
            ...
            style="width: 120px; margin-right: 10px"
          />
          <el-select v-model="searchData.selectObj" placeholder="数据区域" style="width: 120px; margin-right: 10px">
            <el-option v-for="item in objectOptions" :key="item.value" :label="item.label" :value="item.value" />
          </el-select>
      ...
      <div class="table-wrapper">
        <el-table :data="tableData" border stripe>
          ...
          <el-table-column prop="username" label="单位" align="center" />
          <el-table-column prop="username" label="峰值" align="center" />
          <el-table-column prop="username" label="出现时间" align="center" />
          <el-table-column prop="username" label="谷值" align="center" />
          <el-table-column prop="username" label="出现时间" align="center" />
          <el-table-column prop="username" label="平均值" align="center" />
        </el-table>
      </div>
    </el-card>
  </div>
